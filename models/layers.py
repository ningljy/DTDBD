...
class MLPSMOOTH(nn.Module):
    ...
    def __init__(self, input_dim, embed_dims, dropout,logits_shape, output_layer=True):
        ...
        for embed_dim in embed_dims:
            ...
            input_dim = embed_dim
        if output_layer:
            layers.append(torch.nn.Linear(input_dim, logits_shape))
...
class MLPX(nn.Module):
    ...
    def __init__(self, input_dim, embed_dims, dropout, output_layer=True):
        ...
        self.mlpx = torch.nn.Sequential(*layers)
